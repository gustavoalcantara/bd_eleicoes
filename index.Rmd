...
dplyr::filter(dadoseidhm,
  ...
  geom_boxplot()+
  scale_fill_discrete(breaks=c('medio', 'alto', 'muito alto'))+
  coord_flip()
```
Atualizado em 28/2 às 17h20min
